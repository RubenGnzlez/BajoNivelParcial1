...
import models.persons.Residential;

public class John extends Residential{
    ...
    public John(String name, Integer age, Integer birthDay, Integer birthMonth, Integer birthYearM,Boolean titular) {
        this.setName(name);
        this.setAge(age);
