...
import models.persons.subtypes.Teachers;

public class George extends Teachers{
    private String name;
    private Integer age;
    ...
    public George (){
        ...
        this.setBirthYearM(1988);
        this.setStreet("Margaritas");
        this.setExternalNumber(800);
    }

    public George (String name, Integer age, Integer birthDay, Integer birthMonth, Integer birthYearM,Integer externalNumber, String street) {
        this.setName(name);
        this.setAge(age);
